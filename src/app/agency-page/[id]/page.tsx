// src/app/agency-page/[id]/page.tsx
...
export async function generateStaticParams() {
  return agencyData.map((item) => ({
    id: item.id.toString(),
  }));
}

export default function Page({ params }: PageProps) {
  const data = agencyData.find(
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12">
              ...
              <span className="ipn-subtitle">
                {data?.name ? data.name : 'Modern house'}
              </span>
            </div>
          </div>
        </div>
              ...
              <div className="agency agency-list overlio-40">
                ...
                <div className="agency-content">
                  <div className="agency-name">
                    <h4>
                      <Link href="/agency-page">
                        {data?.name ?? 'Modern house'}
                      </Link>
                    </h4>
                    <span>
            ...
            <div className="col-lg-8 col-md-12 col-sm-12">
              <div className="block-wrap">
                <div className="block-header ags">
                  ...
                  <Link href="/add-agent" className="btn btn-seegreen">
                    Add New Agent
                  </Link>
                </div>
