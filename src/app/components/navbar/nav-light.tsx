                ...
                <nav id="navigation" className={windowWidth > 991 ? "navigation navigation-landscape" : "navigation navigation-portrait"}>
                    <div className="nav-header" style={{lineHeight:'0'}}>
                        <Link className="nav-brand text-logo exchange" href="#">
                            {scroll ? (<img src='/img/logo.svg' alt="" width="50" height="50" />) : 
                            (
                                <>
                                   <img src='/img/svg/logo-light.svg' alt="" className='d-none d-lg-block' width="50" height="50" />
                                   <img src='/img/logo.svg' alt="" className='d-block d-lg-none' width="50" height="50" />

                                </>
                            )}
                            
                            <h5 className="fs-3 fw-bold ms-1 my-0">Asta Go</h5>
                        </Link>
                    ...
                    <div className={`nav-menus-wrapper  ${toggle ? 'nav-menus-wrapper-open' : ''}`} style={{transitionProperty:toggle ? 'none' : 'left'}}>
                        ...
                        <ul className="nav-menu">
                         ...
                         <li className={`${activeMenu['chi-siamo']?.main ? 'show' : ''}`}onMouseEnter={() => handleMouseEnter('chi-siamo')}onMouseLeave={() => handleMouseLeave('chi-siamo')}>
                                <Link href="#">Chi Siamo<FiChevronDown className="submenu-indicator" /></Link>

                                   <ul className="nav-dropdown nav-submenu"style={{display: activeMenu['chi-siamo']?.main ? 'block' : 'none',pointerEvents: activeMenu['chi-siamo']?.main ? 'auto' : 'none',}}>
    <li><Link href="#">La società</Link></li>
    <li><Link href="#">La storia</Link></li>
    <li><Link href="#">Innovazione</Link></li>
    <li><Link href="#">Gli accreditamenti</Link></li>
    <li><Link href="#">Partner istituzionali</Link></li>
    <li><Link href="#">Lavora con noi</Link></li>
  </ul>
</li>
